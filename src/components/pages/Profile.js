...
const Profile =()=>{
    ...
    const followersView=()=>{
        return(
                ...
                <Popup trigger={<h6><b>{state?state.followers.length:"0"}</b> followers</h6>} position="bottom  ">
                 <ul className="collection"> followers
              {state?state.followers.map(iteam=>{
                  return(
    ...
    const followingView=()=>{
        return(
            ...
            <Popup trigger={<h6> <b>{state?state.following.length:"0"}</b>following</h6>} position="bottom  ">
            <ul className="collection"> following
         {state?state.following.map(iteam=>{
             return(
               <Link style={{margin:"10px"}} className="collection-item" to={'/profile/'+iteam._id} > <li  >
                   <div>
